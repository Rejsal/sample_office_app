          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: kTextFieldDecoration.copyWith(hintText: jobTitle),
              ),
              const SizedBox(
                height: 20.0,
              ),
              TextFormField(
                ...
                validator: (value) => (value!.isEmpty) ? requiredField : null,
                style: const TextStyle(color: Colors.white),
                decoration:
              ...
              TextFormField(
                ...
                style: const TextStyle(color: Colors.white),
                decoration:
                    kTextFieldDecoration.copyWith(hintText: noOfRequirements),
              ),
              const SizedBox(
                height: 30.0,
              ),
                    ...
                    try {
                      await context.read<JobProvider>().addJob(JobModel(
                          ...
                          numberOfRequirements:
                              int.parse(_noOfRequirementController.text.trim()),
                          filledCount: 0));
                      if (!mounted) return;
